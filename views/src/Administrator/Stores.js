...
import {createTheme, CssBaseline,makeStyles,Paper,Toolbar}    from '@material-ui/core';
 ...
 */
 const HandleLetter =(data)=>{
    const downloadID = data.productID;
    axios.get(`http://localhost:9020/api/products/v2/download/${downloadID}`,{responseType: 'arraybuffer'})
        .then((response) => { 
